...
## Members
- [[Anti-Leakage Policy]] - document - .github/AGENT_CONTEXT.md
...
- [[Entrena un RandomForestClassifier sobre NSL-KDD y devuelve el modelo.]] - rationale - src/baseline_random_forest.py
...
## Top bridge nodes
- [[CICIDSLoadConfig]] - degree 26, connects to 3 communities
- [[load_cicids2017_split()]] - degree 9, connects to 3 communities
- [[load_cicids2017.py]] - degree 18, connects to 1 community
- [[_prepare_cicids_features()]] - degree 9, connects to 1 community
