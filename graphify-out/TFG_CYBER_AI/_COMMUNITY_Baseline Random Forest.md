...
```dataview
TABLE source_file, type FROM #community/Baseline_Random_Forest
SORT file.name ASC
```

## Connections to other communities
- 7 edges to [[_COMMUNITY_Testing Splits]]
- 3 edges to [[_COMMUNITY_Leave-One-Out Eval]]
- 2 edges to [[_COMMUNITY_Hparam Tuning]]
- 2 edges to [[_COMMUNITY_Validation Checks]]
- 1 edge to [[_COMMUNITY_Inference (Deprecated)]]
- 1 edge to [[_COMMUNITY_RL Training Core]]

## Top bridge nodes
- [[load_cicids2017_split()]] - degree 12, connects to 3 communities
