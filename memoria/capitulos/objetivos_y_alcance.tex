...
\bottomrule
\end{tabular}
\caption[Recursos hardware y software del proyecto]{Recursos efectivamente utilizados y procedencia de cada dato. Las versiones observadas proceden de \texttt{environment.json}; los manifiestos expresan contratos de instalación, no observaciones de ejecución.}
\label{tab:recursos}
\end{table}
