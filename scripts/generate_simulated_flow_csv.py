...
DEFAULT_OUTPUT_COLS: List[str] = META_COLS + FLOW_OUTPUT_COLS + TRUTH_COLS
...
def main() -> None:
    ...
    output_columns = get_output_columns(reference_flows) if reference_flows is not None else list(DEFAULT_OUTPUT_COLS)
    reference_windows = (
