...
- **La validación leave-one-CSV-out está implementada, pero no hay un artefacto agregado comprometido en `runs/validation/`**. Por tanto, esa parte debe presentarse como “workflow implementado” y no como resultado medido cerrado.
