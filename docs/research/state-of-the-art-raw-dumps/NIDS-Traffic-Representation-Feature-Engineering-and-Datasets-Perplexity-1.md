...
7. [state_of_the_art.tex] *(presigned S3 URL redacted 2026-07-05: the original Perplexity export embedded a temporary AWS presigned link — AWSAccessKeyId/Signature/x-amz-security-token query string — that expired 2026-05-17; scrubbed at tip, remains in git history per decision D-6, no history rewrite)* - \chapter{State of the Art}
...
33. [references.bib](references.bib)
