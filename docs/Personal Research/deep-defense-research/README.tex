...
\title{Investigación profunda para defensa (paquete multiarchivo)}
\date{}
...
\section{Objetivo de este paquete}
...
\section{Relación con investigaciones previas}
...
\section{Mapa rápido de entradas técnicas del repositorio}
