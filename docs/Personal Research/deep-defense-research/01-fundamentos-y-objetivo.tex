...
\title{Fundamentos y objetivo del TFG}
\date{}

\begin{document}
\maketitle
\section{Fundamentos y objetivo del TFG}

\section{Qué problema resuelve el proyecto}
...
\section{Objetivo real del trabajo}
...
\subsection{Fase 2 (implementada pero abierta en robustez)}
...
\section{Qué está implementado y qué no}
...
\subsection{No implementado todavía}
...
\section{Mensaje fuerte para defensa}
