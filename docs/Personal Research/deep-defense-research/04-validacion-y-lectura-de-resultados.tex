...
\title{Validación y lectura correcta de resultados}
\date{}

\begin{document}
\maketitle

\section{Por qué no basta con una accuracy alta}
...
\section{Check A (evaluación directa)}
...
\section{Check B (anti-leakage con etiquetas barajadas)}
...
\section{Check C (split duro por CSV/día)}
...
\section{Leave-one-exact-CSV-out}
...
\section{Cómo explicar contradicciones aparentes en métricas}
...
\section{Regla metodológica para el tribunal}
