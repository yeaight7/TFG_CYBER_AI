...
\begin{itemize}
  ...
  \item \textbf{Los parámetros de exploración tampoco se fijan explícitamente}. Se heredan los
    ...
    \item \textbf{El script \texttt{train\_rl\_defender.py} contiene una inconsistencia documental
...
\begin{quote}\ttfamily
Accion PERMIT:\\
q05 = -3.2    q50 = 0.1    q95 = 1.7    media $\approx$ -0.2\\

Accion BLOCK:\\
q05 = -0.9    q50 = 0.8    q95 = 1.1    media $\approx$  0.7\\

Decision greedy de SB3: BLOCK\\
Interpretacion: BLOCK tiene mejor retorno esperado y menor dispersión.
\end{quote}
